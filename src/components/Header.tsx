    ...
    <header className="bg-gray-900 sticky top-0 z-50 shadow-lg">
      <div className="max-w-10xl mx-auto px-4 py-2 flex items-center justify-between">
        <a href="#" className="flex items-center mr-4">
          <img src="https://woelper-photovoltaik-waermepumpen.de/wp-content/uploads/2024/12/wpw_logo.png" alt="ecoEnergy Logo" className="h-10" />
        </a>
        ...
        <nav className="hidden md:flex items-center justify-center flex-1 space-x-6">
          <a href="#leistungen" className="text-white hover:text-green-400 transition">Leistungen</a>
          <a href="#produkte" className="text-white hover:text-green-400 transition">Produkte</a>
          <a href="#kontakt" className="text-white hover:text-green-400 transition">Kontakt</a>
          <a href="/public/files/Qualifizierungsnachweis.pdf" target="_blank" className="text-white hover:text-green-400 transition">
            VDI Qualifizierungsnachweis
          </a>
        </nav>

        <a href="#kontakt" className="hidden md:block ml-4 px-4 py-2 rounded-full border-2 border-green-400 text-green-400 hover:bg-green-500 hover:text-white transition duration-300">
          Anfrage
        </a>
